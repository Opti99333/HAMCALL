...
const CONTRACT = "4HvN2bYVr6ncxjRS6oDownFagYRTQwveCKNAk5HGtNQH"
    ...
    {copied ? "✓" : rightBadgeText}
      ...
      <div className="call-controls">
        ...
        <div className="buttons">
          ...
          <a href="https://jup.ag/swap?sell=So11111111111111111111111111111111111111112&buy=4HvN2bYVr6ncxjRS6oDownFagYRTQwveCKNAk5HGtNQH">
            <button className="pill success">{buyerTag}</button>
          </a>
          
          <a className="circle sm" href="https://dexscreener.com/solana/4HvN2bYVr6ncxjRS6oDownFagYRTQwveCKNAk5HGtNQH" target="_blank" rel="noopener noreferrer" aria-label="Open X" title="X" ><img src={dexlogo} alt="" /></a>
